...
- Added subsystem-ablation interpretation (EDE vs ecosystem controls vs trait interactions).
- Added confidence framing to prevent overclaiming from single-pass runs.

## Evidence still weak
- Multi-seed rerun coverage is still limited in the open-endedness suite.
- Some causal claims remain moderate/provisional until rerun variance is measured directly.
