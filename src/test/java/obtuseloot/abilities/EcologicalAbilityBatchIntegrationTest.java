...
class EcologicalAbilityBatchIntegrationTest {
    ...
    void newBatchTriggersDispatchAndOutcomeClassification() {
        AbilityDefinition def = definition("exploration.pathfinder_instinct", AbilityTrigger.ON_CHUNK_ENTER, AbilityMechanic.ECOLOGICAL_PATHING,
    ...
    void harnessScenarioRecordsActivationTelemetryAndNichePresence() {
        ...
        AbilityDefinition explore = definition("exploration.cartographer_echo", AbilityTrigger.ON_STRUCTURE_DISCOVERY, AbilityMechanic.CARTOGRAPHIC_ECHO,
                Set.of("exploration", "map-intelligence"), Set.of("exploration"));
        AbilityDefinition gather = definition("gathering.forager_memory", AbilityTrigger.ON_RESOURCE_HARVEST_STREAK, AbilityMechanic.FORAGING_MEMORY,
