...
public class AbilityRegistry {
    ...
    public AbilityRegistry() {
        this.templates = List.of(
                ...
                template("consistency.path_thread", "Path Thread", AbilityCategory.TRAVERSAL_MOBILITY, AbilityFamily.MOBILITY, AbilityTrigger.ON_WORLD_SCAN, AbilityMechanic.NAVIGATION_ANCHOR,
                ...
                template("exploration.cartographers_echo", "Cartographer's Echo", AbilityCategory.TRAVERSAL_MOBILITY, AbilityFamily.MOBILITY, AbilityTrigger.ON_STRUCTURE_DISCOVERY, AbilityMechanic.CARTOGRAPHERS_ECHO,
                ...
                template("mobility.skyline_fold", "Skyline Fold", AbilityCategory.TRAVERSAL_MOBILITY, AbilityFamily.MOBILITY, AbilityTrigger.ON_CHUNK_ENTER, AbilityMechanic.CARTOGRAPHIC_ECHO,
                ...
                template("combat.rupture_window", "Rupture Window", AbilityCategory.COMBAT_TACTICAL_CONTROL, AbilityFamily.BRUTALITY, AbilityTrigger.ON_REPOSITION, AbilityMechanic.BURST_STATE,
                ...
                template("stealth.intercept_line", "Intercept Line", AbilityCategory.COMBAT_TACTICAL_CONTROL, AbilityFamily.BRUTALITY, AbilityTrigger.ON_ELEVATION_CHANGE, AbilityMechanic.RETALIATION,
                        ...
                        metadata(Set.of("tactical-control", "intercept-routing", "forward-pressure"), Set.of("elevation-shift", "intercept-window", "cut-off-commit"), Set.of("fighter", "pvp", "aggression"), 0.52D, 0.38D, 0.44D, 0.08D, 0.28D, 0.32D)),
                ...
                template("tactical.tempo_extract", "Tempo Extract", AbilityCategory.COMBAT_TACTICAL_CONTROL, AbilityFamily.PRECISION, AbilityTrigger.ON_MOVEMENT, AbilityMechanic.BATTLEFIELD_FIELD,
                ...
                template("warding.fault_survey", "Fault Survey", AbilityCategory.DEFENSE_WARDING, AbilityFamily.PRECISION, AbilityTrigger.ON_BLOCK_INSPECT, AbilityMechanic.DEFENSIVE_THRESHOLD,
                ...
                template("warding.anchor_cadence", "Anchor Cadence", AbilityCategory.DEFENSE_WARDING, AbilityFamily.SURVIVAL, AbilityTrigger.ON_PLAYER_GROUP_ACTION, AbilityMechanic.HARVEST_RELAY,
                ...
                template("warding.false_threshold", "False Threshold", AbilityCategory.DEFENSE_WARDING, AbilityFamily.CHAOS, AbilityTrigger.ON_STRUCTURE_PROXIMITY, AbilityMechanic.DEFENSIVE_THRESHOLD,
                        ...
                        metadata(Set.of("warding", "threshold-deception", "anti-infiltration"), Set.of("structure-proximity", "edge-test-repeat", "intrusion-read"), Set.of("builder", "support", "pvp"), 0.70D, 0.44D, 0.87D, 0.24D, 0.32D, 0.89D)),
                ...
                template("ritual.moon_debt", "Moon Debt", AbilityCategory.RITUAL_STRANGE_UTILITY, AbilityFamily.CHAOS, AbilityTrigger.ON_TIME_OF_DAY_TRANSITION, AbilityMechanic.RITUAL_CHANNEL,
