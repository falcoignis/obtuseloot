...
public final class PlayerArtifactTriggerMap {
    ...
    public static PlayerArtifactTriggerMap fromBindings(List<ArtifactTriggerBinding> bindings, String reason, long rebuildNanos) {
        ...
        return new PlayerArtifactTriggerMap(grouped, bindings.size(), rebuildNanos, reason);
    }
