...
1. did dominant niche share decrease? dominantShare(final)=1.0 and occupancy={niche-1=1.0}.
2. did underrepresented niches survive longer? speciesFractionByNiche={niche-1=1.0}.
3. did END improve? latest END=0.0.
4. did TNT remain healthy instead of chaotic? latest TNT=0.0.
5. did NSER improve? latest NSER=1.0.
