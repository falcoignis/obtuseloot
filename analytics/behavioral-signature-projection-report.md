...
- Top separation contributors: [trigger_class_activation_distribution, interaction_diversity, mechanic_usage_distribution]
...
- Separation dimensions with strongest variance now: [trigger_class_activation_distribution, interaction_diversity, mechanic_usage_distribution]
- Niche interpretability map: {niche-1=stable niche with dominant branch=mobility.lane, dominant family=chaos, successRate=0.98, niche-2=stable niche with dominant branch=chaos.paradox, dominant family=survival, successRate=0.77}

## Impact on niche count and occupancy
- Niche count: 1
- Occupancy: {niche-1=80}
